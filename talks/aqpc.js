...
const AGENDA = {
  fr: [
    ...
    { time:'5–7 min',   type:'intro',       typeLabel:'Vue d\'ensemble', title:'L\'IA dans notre réseau',    desc:'Aperçu du sondage réseau LCI — 136 répondant.e.s, 11 institutions.' },
    { time:'7–12 min',  type:'intro',       typeLabel:'Présentation', title:'Leçons tirées du terrain',        desc:"Enjeux et solutions identifiés par onze équipes programmes à Collège LaSalle." },
  ...
  en: [
    ...
    { time:'5–7 min',   type:'intro',       typeLabel:'Overview',     title:'AI in our network',              desc:'Quick look at the LCI network survey — 136 respondents, 11 institutions.' },
    { time:'7–12 min',  type:'intro',       typeLabel:'Presentation', title:'Lessons from the Field',         desc:'Issues and solutions identified by eleven programme teams at Collège LaSalle.' },
...
const PHASES = {
  fr: [
    ...
    { lbl:'Vue d\'ensemble ~ 2 min',    start:53, sec:'overview' },
    { lbl:'Leçons ~ 5 min',              start:48, sec:'lessons' },
  ...
  en: [
    { lbl:'Intro ~ 5 min',            start:55, sec:'intro' },
    { lbl:'Overview ~ 2 min',         start:53, sec:'overview' },
    { lbl:'Lessons ~ 5 min',          start:48, sec:'lessons' },
  ...
  es: [
    { lbl:'Intro ~ 5 min',              start:55, sec:'intro' },
    { lbl:'Panorama ~ 2 min',           start:53, sec:'overview' },
    { lbl:'Lecciones ~ 5 min',          start:48, sec:'lessons' },
...
function updateHtmlFields() {
  ...
  const textIds = [
    ...
    'hero-cta','async-h4','async-p','agenda-tag','agenda-h2','agenda-p','context-p',
...
const OVERVIEW_STR = {
  fr: {
    ...
    formh4:  'Partagez votre expérience',
    formp:   'Répondez au même sondage que vos collègues du réseau LCI — vos réponses vous permettront de situer votre établissement par rapport aux données présentées ici. Optionnel, à tout moment après l\'atelier.',
    formbtn: 'Répondre au sondage →',
  ...
  en: {
    ...
    formh4:  'Share your experience',
    formp:   'Answer the same survey as your LCI network colleagues — your responses will let you situate your institution against the data shown here. Optional, any time after the workshop.',
    formbtn: 'Take the survey →',
  ...
  es: {
    ...
    formh4:  'Compartid vuestra experiencia',
    formp:   'Responded al mismo sondeo que vuestros colegas de la red LCI — vuestras respuestas os permitirán situar vuestra institución respecto a los datos presentados aquí. Opcional, en cualquier momento después del taller.',
    formbtn: 'Responder al sondeo →',
...
function renderOverview() {
  ...
  const fields = {
    ...
    'overview-form-h4':   t.formh4,
    'overview-form-p':    t.formp,
    'overview-form-btn':  t.formbtn,
  };
...
// ── VISUALISER ──────────────────────────────────────────────────────────────
    ...
    const VIZ_PROGRAMS = {
      "420.BR": {
        ...
        "courses": [
          {"session":1,"title":"Mathématiques appliquées à l'informatique","course_level":2,"eval_levels":[0,0,0,0]},
          ...
          {"session":2,"title":"Réseaux, routage et commutation","course_level":3,"eval_levels":[3,0,0]},
          {"session":2,"title":"Système d'exploitation serveur I","course_level":3,"eval_levels":[0,2,0]},
          {"session":3,"title":"Réseau, Sécurité et Automatisation","course_level":3,"eval_levels":[3,0,0]},
          ...
          {"session":4,"title":"Cybersécurité I","course_level":3,"eval_levels":[3,0,0]},
          ...
          {"session":6,"title":"Étude de cas intégratrice de compétences","course_level":3,"eval_levels":[2,2]},
          {"session":6,"title":"Gestion d'un parc informatique","course_level":3,"eval_levels":[0,2]},
          {"session":6,"title":"Intégration en entreprise - gestion de réseaux et sécurité","course_level":3,"eval_levels":[]},
        ...
        "courses": [
          ...
          {"session":3,"title":"Modélisation UML","course_level":0,"eval_levels":[0,2,0]},
          {"session":3,"title":"Bases de données II","course_level":0,"eval_levels":[0,1,0]},
          {"session":3,"title":"Développement d'applications multi-tiers","course_level":0,"eval_levels":[0,1,0]},
          {"session":3,"title":"Langage de script","course_level":0,"eval_levels":[0,2,0]},
          {"session":4,"title":"Développement d'applications web serveur I","course_level":0,"eval_levels":[0,2,0]},
          {"session":4,"title":"Programmation orientée objet avancée","course_level":null,"eval_levels":[0,2,0]},
          {"session":4,"title":"Structure de données","course_level":null,"eval_levels":[0,2,0]},
          {"session":5,"title":"Développement mobile Android","course_level":null,"eval_levels":[0,2,0]},
          {"session":5,"title":"Langage de script II","course_level":0,"eval_levels":[0,2,0]},
          {"session":5,"title":"Développement d'applications web serveur II","course_level":0,"eval_levels":[0,2,0]},
          {"session":5,"title":"Système d'exploitation et réseautique","course_level":0,"eval_levels":[0,2,0]},
          {"session":5,"title":"Intégration professionnelle","course_level":0,"eval_levels":[null,2,0]},
          {"session":6,"title":"Développement mobile IOS","course_level":null,"eval_levels":[0,2,0]},
